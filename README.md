...
> Console-based app to manage guests, rooms & billing. Built with JDBC for persistent CRUD and a normalized MySQL schema.
> [View Repository →](https://github.com/mt320236/hotel-management-system)

**🌐 REST API Development** — `Spring Boot · Spring Data JPA · MySQL`
> CRUD REST APIs with proper HTTP methods, tested using Postman. Connected to MySQL via Spring Data JPA.
> [View Repository →](https://github.com/mt320236/Spring-boot-learning)
